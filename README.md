...
Soy estudiante de **Análisis y Desarrollo de Software**. Estoy construyendo mi camino como desarrollador con proyectos prácticos, buenas prácticas de Git/GitHub y mucho código con sabor a progreso.

- 🌱 Aprendiendo: **JavaScript, Python, Git, GitHub, HTML y CSS**
- 🧩 Enfocado en: lógica, APIs, CRUDs, interfaces y flujo profesional con ramas
- ⚽ Fan del fútbol y de convertir errores en aprendizaje
- 🎯 Meta: crecer como **Full Stack Developer**
- 🔥 Filosofía: practicar, romper, arreglar, documentar y repetir
...
| Nivel | Tema | Estado |
|---|---|---|
| 🟢 Base | HTML, CSS, JavaScript | En práctica |
| 🟡 Lógica | Funciones, arrays, objetos, DOM | Mejorando |
| 🟣 Backend | Node.js, APIs, JSON | En proceso |
| 🔵 GitHub | Ramas, PRs, Issues, Actions | Practicando |
| 🔥 Meta | Full Stack Developer | En construcción |
...
<p align="center">
  <img
    src="https://capsule-render.vercel.app/api?type=waving&color=0:00C9FF,50:6A11CB,100:141E30&height=150&section=footer"
    alt="Footer"
  />
</p>
